...
#define LCD_FRAME_BUFFER       ((uint32_t)0xD0000000)     // 第1层（背景层）首地址
#define BUFFER_OFFSET          ((uint32_t)800*480*2)      // 一帧图像的字节数，因为使用ARGB1555格式，所以1像素占用2字节
...
/**
  * @brief LCD default font   LCD字体
  */
#define LCD_DEFAULT_FONT         Font16x24

/**
  * @brief  LCD Direction     LCD方向
  */
#define LCD_DIR_HORIZONTAL       0x0000
#define LCD_DIR_VERTICAL         0x0001
